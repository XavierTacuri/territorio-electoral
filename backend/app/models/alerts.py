...
class AlertRule(Base):
    ...
    __table_args__ = (
        CheckConstraint("module IN ('OPERATIONS','COMMITMENTS','SURVEYS','DATA_IMPORTS','ELECTORAL_DATA','DEMOGRAPHICS','GEOMETRY','DATA_QUALITY','PUBLIC_INTELLIGENCE','EVIDENCE','REPORTS')", name="module"),
