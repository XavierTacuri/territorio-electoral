...
class ActivityStatus(StrEnum):PLANNED="PLANNED";IN_PROGRESS="IN_PROGRESS";COMPLETED="COMPLETED";SUSPENDED="SUSPENDED";CANCELLED="CANCELLED"
...
class TerritorialActivityCreate(BaseModel):
    activity_type_code:str;title:str;description:str|None=None;activity_date:date;status:ActivityStatus=ActivityStatus.PLANNED;parish_id:int;community_id:UUID|None=None;sector_id:UUID|None=None;location_name:str|None=None;latitude:float|None=Field(None,ge=-90,le=90);longitude:float|None=Field(None,ge=-180,le=180);responsible_user_id:UUID|None=None;start_time:time|None=None;end_time:time|None=None;client_generated_id:UUID|None=None
...
class TerritorialActivitySummary(BaseModel):
    id:UUID;campaign_id:UUID;activity_type_id:int;title:str;activity_date:date;status:ActivityStatus;approval_status:ApprovalStatus;parish_id:int;parish_name:str|None=None;community_id:UUID|None;sector_id:UUID|None;is_active:bool;created_by_user_id:UUID;start_time:time|None=None;end_time:time|None=None;client_generated_id:UUID|None=None
    model_config=ConfigDict(from_attributes=True)
class ActivityActorRead(BaseModel):
    id:UUID;display_name:str;username:str;role_codes:list[str]
class TerritorialActivityRead(TerritorialActivitySummary):description:str|None;location_name:str|None;latitude:float|None;longitude:float|None;responsible_user_id:UUID|None;submitted_for_approval_at:datetime|None;submitted_by_user_id:UUID|None;approved_at:datetime|None;approved_by_user_id:UUID|None;approved_by:ActivityActorRead|None=None;rejected_at:datetime|None;rejected_by_user_id:UUID|None;rejected_by:ActivityActorRead|None=None;rejection_reason:str|None;completion_summary:str|None;outcome_notes:str|None;completed_at:datetime|None;completed_by_user_id:UUID|None;completed_by:ActivityActorRead|None=None;cancellation_reason:str|None;cancelled_at:datetime|None;cancelled_by_user_id:UUID|None;suspension_reason:str|None;suspended_at:datetime|None;suspended_by_user_id:UUID|None;suspended_by:ActivityActorRead|None=None;resumed_by:ActivityActorRead|None=None
class ActivityCloseNeedCreate(BaseModel):
    need_category_code:str;title:str;description:str|None=None;mentions_count:int=Field(1,ge=1);priority:Priority=Priority.MEDIUM;urgency:Priority|None=None;status:NeedStatus=NeedStatus.REPORTED;source_type:NeedSourceType=NeedSourceType.CAMPAIGN_ACTIVITY;scope:NeedScope=NeedScope.PARISH;local_sector_description:str|None=None;assigned_to_user_id:UUID|None=None;evidence_notes:str|None=None;source_reference:str|None=None
    model_config=ConfigDict(extra="forbid");_title=field_validator("title")(clean)
    @model_validator(mode="after")
    def local_scope(self):
        if self.scope==NeedScope.LOCAL and not (self.local_sector_description or "").strip():raise ValueError("El alcance local requiere descripciÃ³n del sector")
        return self
class ActivityCloseCommitmentCreate(BaseModel):
    title:str;description:str|None=None;priority:Priority=Priority.MEDIUM;status:CommitmentStatus=CommitmentStatus.PENDING;due_date:date|None=None;completed_date:date|None=None;responsible_user_id:UUID|None=None;need_id:UUID|None=None
    model_config=ConfigDict(extra="forbid");_title=field_validator("title")(clean)
    @model_validator(mode="after")
    def completed(self):
...
class ActivityCloseRequest(BaseModel):
    summary:str=Field(min_length=10,max_length=5000);outcome_notes:str|None=Field(None,max_length=5000);existing_need_ids:list[UUID]=Field(default_factory=list);new_needs:list[ActivityCloseNeedCreate]=Field(default_factory=list);commitments:list[ActivityCloseCommitmentCreate]=Field(default_factory=list)
    model_config=ConfigDict(extra="forbid");_summary=field_validator("summary")(clean)
class ActivityCancelRequest(BaseModel):
    reason:str=Field(min_length=3,max_length=1000);model_config=ConfigDict(extra="forbid");_reason=field_validator("reason")(clean)
class ActivitySuspendRequest(BaseModel):
    reason:str=Field(min_length=3,max_length=2000);model_config=ConfigDict(extra="forbid");_reason=field_validator("reason")(clean)
...
class CommitmentCreate(BaseModel):
    activity_id:UUID|None=None;need_id:UUID|None=None;title:str;description:str|None=None;priority:Priority=Priority.MEDIUM;status:CommitmentStatus=CommitmentStatus.PENDING;due_date:date|None=None;completed_date:date|None=None;responsible_user_id:UUID|None=None;parish_id:int;community_id:UUID|None=None;sector_id:UUID|None=None
    model_config=ConfigDict(extra="forbid");_title=field_validator("title")(clean)
    @model_validator(mode="after")
    def completed(self):
        if self.completed_date and self.status!=CommitmentStatus.COMPLETED:raise ValueError("completed_date requiere estado COMPLETED")
        if self.completed_date and self.completed_date>date.today():raise ValueError("Fecha de realización futura")
        if self.sector_id and not self.community_id:raise ValueError("Un sector requiere comunidad")
        return self
class CommitmentUpdate(BaseModel):
    ...
    model_config=ConfigDict(extra="forbid")
class CommitmentSummary(BaseModel):id:UUID;campaign_id:UUID;activity_id:UUID|None;need_id:UUID|None;title:str;priority:Priority;status:CommitmentStatus;due_date:date|None;completed_date:date|None;responsible_user_id:UUID|None;responsible_name:str|None=None;parish_id:int;is_active:bool;model_config=ConfigDict(from_attributes=True)
...
class ActivityEvidenceRead(BaseModel):id:UUID;activity_id:UUID;evidence_type:EvidenceType;title:str;description:str|None;url:str|None;evidence_date:date|None;is_active:bool;mime_type:str|None=None;size_bytes:int|None=None;original_filename:str|None=None;client_generated_id:UUID|None=None;model_config=ConfigDict(from_attributes=True)
